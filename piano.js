...
const noteCSharp = document.getElementById('noteCSharp')
const noteD = document.getElementById('noteD')
const noteDSharp = document.getElementById('noteDSharp')
const noteE = document.getElementById('noteE')
const noteF = document.getElementById('noteF')
const noteFSharp = document.getElementById('noteFSharp')
const noteG = document.getElementById('noteG')
const noteGSharp = document.getElementById('noteGSharp')
